            ...
            <div className="md:w-[480px] p-8 bg-white shadow rounded-lg ">
                        ...
                        {!showOtp ? (
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <h3 className="text-2xl font-semibold text-center mb-4">
                                    Create your account & Sell on HUZA
                                </h3>
                                ...
                                <input type="tel"
                                    placeholder="Your phone number without spaces"
                                ...
                                <button
                                    ...
                                    className="w-full text-lg cursor-pointer mt-4 bg-black text-white py-3 rounded-lg"
                                >
                                ...
                                <div className="flex justify-center gap-6">
                                    {otp?.map((digit, index) => (
                                        <input
                                            ...
                                            maxLength={1}
                                            className="w-12 h-12 text-center text-xl border border-gray-300 outline-none !rounded"
                                            value={digit}
                ...
                {activeStep === 3 && (
                    <div className="text-center">
                        ...
                        <p className="mt-2 mb-4">Choose how you'd like to receive payments</p>

                        <div className="space-y-3">
                            <Link
                                href={`/signup/momo?sellerId=${sellerId}`}
                                className="block w-full text-lg bg-yellow-500 text-white py-3 rounded-lg"
                            >
                                Receive via MTN Mobile Money
                            </Link>

                            <Link
                                href={`/signup/bank?sellerId=${sellerId}`}
                                className="block w-full text-lg bg-green-600 text-white py-3 rounded-lg"
                            >
                                Receive via Bank Account
                            </Link>
